...
// for display purposes
      ...
      git 'https://github.com/pomkarr/hello-world-servlet.git'
...
post {
        success {
            mail to:"panthangiomkar77@gmail.com", subject:"SUCCESS: ${currentBuild.fullDisplayName}", body: "Build success"
        }
        failure {
            mail to:"panthangiomkar77@gmail.com", subject:"FAILURE: ${currentBuild.fullDisplayName}", body: "Build failed"
        }
    }       
}
